import aiosqlite
  ...
  # Railway da persistent volume uchun DB_PATH ni env dan olish mumkin
  # Railway dashboard'da: DB_PATH=/data/waifu_bot.db va /data volume qo'shing
  _default_db_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "waifu_bot.db")
  ...
  async def init_db():
      # DB fayl joylashgan papkani yaratish (persistent volume uchun)
      ...
      async with aiosqlite.connect(DB_PATH) as db:
          ...
          # Mavjud jadvallarni xavfsiz yangilash (migration)
          for migration in [
